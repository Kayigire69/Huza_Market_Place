...
3. On Neon/App Platform use the pooler `DATABASE_URL`. Production build auto-derives a non-pooler URL for `prisma migrate deploy` (or set optional `DIRECT_URL`).
